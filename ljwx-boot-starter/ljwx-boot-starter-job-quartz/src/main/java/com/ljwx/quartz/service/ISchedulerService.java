package com.ljwx.quartz.service;
 ...
 * @ClassName com.ljwx.quartz.service.ISchedulerService
...
public interface ISchedulerService {
    ...
    /**
     * 立即执行任务 - 支持传递JobDataMap参数
     *
     * @param jobName  作业名称
     * @param jobGroup 作业组别
     * @param jobDataMap 作业参数
     * @author bruno.gao <gaojunivas@gmail.com>
     * @CreateTime 2024-07-02 - 08:30:00
     */
    void immediate(String jobName, String jobGroup, org.quartz.JobDataMap jobDataMap);
