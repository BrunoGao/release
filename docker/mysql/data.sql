-- MySQL 8.0 compatible initialization script
-- LJWX System Complete Database with Multi-tenant Support

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;
SET SQL_MODE = 'NO_AUTO_VALUE_ON_ZERO';

-- Import complete structure
...
-- 插入基础组织数据
INSERT INTO `sys_org_units` (`id`, `parent_id`, `name`, `code`, `abbr`, `level`, `ancestors`, `description`, `sort`, `create_user`, `create_user_id`, `create_time`, `update_user`, `update_user_id`, `update_time`, `status`, `is_deleted`, `customer_id`) VALUES
(1939964806110937090, NULL, '灵境万象科技', 'LJWX', '灵境万象', 1, '1939964806110937090', '灵境万象科技有限公司', 1, 'admin', 1, NOW(), NULL, NULL, NULL, '1', 0, 1939964806110937090);

-- 插入组织层级缓存
INSERT INTO `sys_org_closure` (`ancestor_id`, `descendant_id`, `depth`, `create_time`, `customer_id`) VALUES
(1939964806110937090, 1939964806110937090, 0, NOW(), 1939964806110937090);
