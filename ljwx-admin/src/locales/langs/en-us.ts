const local: App.I18n.Schema = {
  ...
  route: {
    ...
    device_bind: 'Device Binding Management',
    device_config: 'Device Configuration',
    device_user: 'Device Binding History',
    device_info: 'Device List',
    device_message: 'Message List',
    ...
    job: 'Job Guide',
    bigscreen: 'Overview Dashboard',
    customer: 'Customer Management',
    customer_config: 'Customer Configuration',
    customer_data: 'Customer Data',
    customer_interface: 'Customer Interface Configuration',
    alert: 'Alert Management',
    alert_config: 'Alert Configuration',
    alert_config_wechat: 'WeChat Alert Configuration',
