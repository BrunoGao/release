      ...
      page: {
        ...
        health: {
          ...
          device: {
            ...
            config: {
              spo2measureperiod: string;
              stressmeasureperiod: string;
              bodytemperaturemeasureperiod: string;
              heartratewarninghigh: string;
              heartratewarninglow: string;
              spo2warning: string;
              stresswarning: string;
              bodytemperaturehighwarning: string;
              bodytemperaturelowwarning: string;
              httpurl: string;
              logo: string;
              uitype: string;
              bodytemperaturewarningcnt: string;
              heartwarningcnt: string;
              heartratemeasureperiod: string;
              spo2warningcnt: string;
              stressmonitoringenabled: string;
              stepsmonitoringenabled: string;
              distancemonitoringenabled: string;
              caloriemonitoringenabled: string;
              sleepmonitoringenabled: string;
              ecgmonitoringenabled: string;
              locationmonitoringenabled: string;
              soseventlistenerenabled: string;
              doubleclickeventlistenerenabled: string;
              temperatureabnormallistenerenabled: string;
              heartrateabnormallistenerenabled: string;
              stressabnormallistenerenabled: string;
              falleventlistenerenabled: string;
              spo2abnormallistenerenabled: string;
              oneclickalarmlistenerenabled: string;
              wearingstatuslistenerenabled: string;
              createUser: string;
              createTime: string;
              form: {
                spo2measureperiod: string;
