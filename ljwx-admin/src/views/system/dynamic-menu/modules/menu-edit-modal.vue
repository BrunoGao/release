  ...
  >
    ...
    >
      <NGrid :cols="2" x-gap="16">
        <!-- 基础信息 -->
        <NGridItem :span="2">
          <div class="text-base font-medium mb-12px">基础信息</div>
        </NGridItem>
        ...
        <!-- 路由配置 -->
        <NGridItem :span="2">
          <div class="text-base font-medium mb-12px mt-16px">路由配置</div>
        </NGridItem>
        ...
        <NGridItem v-if="formModel.type === '2'">
          <NFormItem label="iframe地址" path="iframeUrl">
            <NInput
              v-model:value="formModel.iframeUrl"
              placeholder="iframe地址（可选）"
            />
          </NFormItem>
        </NGridItem>
        ...
        <!-- 图标配置 -->
        <NGridItem :span="2">
          <div class="text-base font-medium mb-12px mt-16px">图标配置</div>
        </NGridItem>
        ...
        <!-- 状态配置 -->
        <NGridItem :span="2">
          <div class="text-base font-medium mb-12px mt-16px">状态配置</div>
        </NGridItem>
        ...
        <!-- 权限配置 -->
        <NGridItem :span="2">
          <div class="text-base font-medium mb-12px mt-16px">权限配置</div>
        </NGridItem>
        ...
        <!-- 其他配置 -->
        <NGridItem :span="2">
          <div class="text-base font-medium mb-12px mt-16px">其他配置</div>
        </NGridItem>
