    ...
    formatter: params => {
      ...
      return `
        <div>
          ...
          <strong>Heart Rate:</strong> ${rate}<br/>
  ...
  series: [
    {
      ...
      markLine: {
        data: [
          { yAxis: 60, name: $t('page.health.chart.lowThreshold'), lineStyle: { color: '#ff7f50' } },
          { yAxis: 100, name: $t('page.health.chart.highThreshold'), lineStyle: { color: '#ff7f50' } }
        ]
      },
      emphasis: {
        focus: 'series'
      ...
      itemStyle: {
        color: params => {
          if (params.value > 100 || params.value < 60) {
