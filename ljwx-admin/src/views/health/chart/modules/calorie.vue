...
const { domRef, updateOptions } = useEcharts(() => ({
  ...
  legend: {
    data: [$t('page.health.chart.calorie')]
  },
  grid: {
    left: '3%',
    right: '4%',
  ...
  series: [
    {
      name: $t('page.health.chart.calorie'),
      type: 'line',
      smooth: true,
      ...
      markLine: {
        data: [
          { yAxis: 40, name: $t('page.health.chart.lowThreshold'), lineStyle: { color: '#ff7f50' } },
          { yAxis: 60, name: $t('page.health.chart.highThreshold'), lineStyle: { color: '#ff7f50' } }
        ]
      },
      emphasis: {
        focus: 'series'
      ...
      itemStyle: {
        color: params => {
          if (params.value > 60 || params.value < 40) {
