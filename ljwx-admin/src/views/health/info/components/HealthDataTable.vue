...
import { NButton, NCard, NDataTable, NProgress, NSkeleton, NSpace, NTag, NTooltip } from 'naive-ui';
    ...
    <NCard :bordered="false" class="card-wrapper">
      <template #header>
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            <NTag v-if="props.loading || loading" type="warning" size="small">加载中...</NTag>
            <NButton size="small" :loading="loading" @click="loadTableData()">刷新数据</NButton>
          </div>
        </div>
      </template>
