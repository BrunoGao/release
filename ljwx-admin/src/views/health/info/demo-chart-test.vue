  ...
  <div class="p-6 bg-gray-50 min-h-screen">
    <div class="max-w-6xl mx-auto">
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-2">🏥 健康数据可视化演示</h1>
        <p class="text-gray-600">展示慢字段数据的优雅可视化效果</p>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <NCard class="hover:shadow-lg transition-shadow">
          <template #header>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <NCard class="bg-red-50 border-red-200">
          <template #header>
        ...
        <NCard class="bg-green-50 border-green-200">
          <template #header>
        ...
        <NCard class="bg-blue-50 border-blue-200">
          <template #header>
