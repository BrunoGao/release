...
import { type Ref, h, onMounted, ref, shallowRef } from 'vue';
...
import { deviceOptions, handleBindDevice, handleBindUsers } from '@/utils/deviceUtils';
...
const { columns, columnChecks, data, loading, getData, getDataByPage, mobilePagination, searchParams, resetSearchParams } = useTable({
  ...
  columns: () => [
    ...
    {
      key: 'message',
      title: $t('page.task.message'),
      align: 'center',
      width: 400
    },
    {
      key: 'messageType',
      title: $t('page.task.messageType'),
      align: 'center',
      minWidth: 100,
    ...
    {
      key: 'messageStatus',
      title: $t('page.task.messageStatus'),
      align: 'center',
      minWidth: 100,
      render: row => {
        let status = row.messageStatus;
        // if (row.respondedNumber > 0) {
        ...
        return dictTag('message_status', status);
      }
    },
    {
      key: 'sentTime',
