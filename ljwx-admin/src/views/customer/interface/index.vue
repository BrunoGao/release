          ...
          <div class="max-h-400px overflow-y-auto text-sm space-y-4">
                  ...
                  <NSpace>
                    <NIcon size="16" color="#18a058">
                      <svg viewBox="0 0 24 24">
                        <path
                          fill="currentColor"
                          d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H6.99c-2.76 0-5 2.24-5 5s2.24 5 5 5H11v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm5-6h4.01c2.76 0 5 2.24 5 5s-2.24 5-5 5H13v1.9h4.01c2.76 0 5-2.24 5-5s-2.24-5-5-5H13V7z"
                        />
                      </svg>
                    </NIcon>
                    <div>
                  ...
                  <NSpace>
                    <NIcon size="16" color="#d03050">
                      <svg viewBox="0 0 24 24">
                        <path
                          fill="currentColor"
                          d="M7.5 5.6L10 7L8.6 4.5L10 2L7.5 3.4L5 2l1.4 2.5L5 7l2.5-1.4zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14l-2.5 1.4zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5L22 2zM13.34 12.78l-1.12-1.12l-6.01 6.01l1.12 1.12l6.01-6.01z"
                        />
                      </svg>
                    </NIcon>
                    <div>
            ...
            <NCard title="⚙️ 配置项影响" size="small">
              <NList>
                <NListItem>
                  <div>
                    <div class="text-orange-600 font-medium">⏱️ 调用间隔设置</div>
                    <div class="mt-1 text-gray-600">• 影响：数据同步实时性和系统负载</div>
                ...
                <NListItem>
                  <div>
                    <div class="text-blue-600 font-medium">🔒 API认证配置</div>
                    <div class="mt-1 text-gray-600">• 影响：外部接口访问权限和安全性</div>
                ...
                <NListItem>
                  <div>
                    <div class="text-green-600 font-medium">🌐 接口URL配置</div>
                    <div class="mt-1 text-gray-600">• 影响：决定数据来源和通信路径</div>
                ...
                <NListItem>
                  <div>
                    <div class="text-purple-600 font-medium">🔧 请求方法选择</div>
                    <div class="mt-1 text-gray-600">• 影响：接口调用方式和数据传输格式</div>
              ...
              <NList>
                <NListItem>
                  <div>
                    ...
                    <div class="mt-1 text-gray-600">点击"新增"按钮 → 填写接口名称和URL → 设置调用间隔 → 配置认证信息 → 测试连通性 → 保存</div>
                  </div>
                </NListItem>
                <NListItem>
                  <div>
                    <div class="font-medium">2. 编辑接口配置</div>
                    <div class="mt-1 text-gray-600">点击"编辑"按钮 → 修改配置参数 → 验证接口可用性 → 保存更改</div>
                  </div>
                </NListItem>
                <NListItem>
                  <div>
                    <div class="font-medium">3. 接口测试</div>
                    <div class="mt-1 text-gray-600">配置完成后建议进行连通性测试，确保外部系统正常响应</div>
                  </div>
                </NListItem>
                <NListItem>
                  <div>
                    <div class="font-medium">4. 监控调用状态</div>
                    <div class="mt-1 text-gray-600">定期检查接口调用日志，及时发现和处理异常情况</div>
                  </div>
                </NListItem>
              </NList>
            </NCard>
              ...
              <NList>
                <NListItem>
                  <div>
                    ...
                    <div class="mt-1 text-gray-600">• 优先使用HTTPS协议加密传输</div>
                ...
                <NListItem>
                  <div>
                    ...
                    <div class="mt-1 text-gray-600">• 配置IP白名单限制访问来源</div>
