...
import { NAlert, NButton, NCard, NCollapse, NCollapseItem, NIcon, NList, NListItem, NPopconfirm, NSpace } from 'naive-ui';
          ...
          <div class="max-h-400px overflow-y-auto text-sm space-y-4">
                  ...
                  <NSpace>
                    <NIcon size="16" color="#e74c3c">
                      <svg viewBox="0 0 24 24">
                        <path
                          fill="currentColor"
                          d="M4.8 2h14.4C20.26 2 21 2.74 21 3.8v16.4c0 1.06-.74 1.8-1.8 1.8H4.8C3.74 22 3 21.26 3 20.2V3.8C3 2.74 3.74 2 4.8 2z"
                        />
                      </svg>
                    </NIcon>
                    <div>
                  ...
                  <NSpace>
                    <NIcon size="16" color="#27ae60">
                      <svg viewBox="0 0 24 24">
                        <path
                          fill="currentColor"
                          d="M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zM9.8 8.5L6 13.5l1.5 1.5c.5.5 1.1.5 1.6 0L12 12l2.9 3c.5.5 1.1.5 1.6 0l1.5-1.5L14.2 8.5c-.4-.8-1.3-1.3-2.2-1.3H12c-.9 0-1.8.5-2.2 1.3z"
                        />
                      </svg>
                    </NIcon>
                    <div>
                  ...
                  <NSpace>
                    <NIcon size="16" color="#8e44ad">
                      <svg viewBox="0 0 24 24">
                        <path
                          fill="currentColor"
                          d="M12 2c-4.97 0-9 4.03-9 9 0 4.17 2.84 7.67 6.69 8.69L12 22l2.31-2.31C18.16 18.67 21 15.17 21 11c0-4.97-4.03-9-9-9zm0 2c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3z"
                        />
                      </svg>
                    </NIcon>
                    <div>
            ...
            <NCard title="⚙️ 配置参数说明" size="small">
              <NList>
                <NListItem>
                  <div>
                    <div class="text-blue-600 font-medium">📊 采集频率间隔</div>
                    <div class="mt-1 text-gray-600">• 影响：健康数据采集的时间间隔</div>
                ...
                <NListItem>
                  <div>
                    <div class="text-orange-600 font-medium">⚠️ 预警阈值设置</div>
                    <div class="mt-1 text-gray-600">• 影响：告警触发的临界值</div>
                ...
                <NListItem>
                  <div>
                    <div class="text-green-600 font-medium">🎯 预警次数限制</div>
                    <div class="mt-1 text-gray-600">• 影响：连续超阈值多少次后才触发告警</div>
                ...
                <NListItem>
                  <div>
                    <div class="text-purple-600 font-medium">⚖️ 数据权重</div>
                    <div class="mt-1 text-gray-600">• 影响：该指标在健康评分中的重要程度</div>
              ...
              <NList>
                <NListItem>
                  <div>
                    ...
                    <div class="mt-1 text-gray-600">选择数据类型 → 设置采集频率 → 配置预警阈值 → 设置权重比例 → 启用监测</div>
                  </div>
                </NListItem>
                <NListItem>
                  <div>
                    <div class="font-medium">2. 调整预警参数</div>
                    <div class="mt-1 text-gray-600">点击"编辑"按钮 → 修改高低阈值 → 调整预警次数 → 验证设置合理性 → 保存</div>
                  </div>
                </NListItem>
                <NListItem>
                  <div>
                    <div class="font-medium">3. 优化采集策略</div>
                    <div class="mt-1 text-gray-600">根据设备电量和数据重要性，平衡采集频率和电池续航</div>
                  </div>
                </NListItem>
                <NListItem>
                  <div>
                    <div class="font-medium">4. 个性化配置</div>
                    <div class="mt-1 text-gray-600">考虑用户年龄、职业、病史等因素，制定个性化监测方案</div>
                  </div>
                </NListItem>
              </NList>
            </NCard>
              ...
              <NList>
                <NListItem>
                  <div>
                    ...
                    <div class="mt-1 text-gray-600">• 参考医学标准范围，结合个体差异</div>
                ...
                <NListItem>
                  <div>
                    ...
                    <div class="mt-1 text-gray-600">• 白天采集频率可以提高</div>
                ...
                <NListItem>
                  <div>
                    ...
                    <div class="mt-1 text-gray-600">• 总权重保持1.0平衡</div>
