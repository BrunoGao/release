...
public interface ITDeviceMessageDetailService extends IService<TDeviceMessageDetail> {
     ...
     * @param tDeviceMessageDetailBO BO 查询对象
     * @return {@link IPage} 分页结果
     * @author payne.zhuang
     * @CreateTime 2025-03-05 - 19:57:37
     */
    IPage<TDeviceMessageDetail> listTDeviceMessageDetailPage(PageQuery pageQuery, TDeviceMessageDetailBO tDeviceMessageDetailBO);
}
