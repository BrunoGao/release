...
public class DepartmentHealthAggregationJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        log.info("🚀 开始执行部门健康基线聚合作业: {}", jobName);
        ...
        try {
            ...
            log.info("✅ 部门健康基线聚合作业完成: {}, 耗时: {}ms", jobName, executionTime);
            
        } catch (Exception e) {
            log.error("❌ 部门健康基线聚合作业失败: {}, 错误: {}", jobName, e.getMessage(), e);
            throw new JobExecutionException("部门健康基线聚合失败: " + e.getMessage(), e);
        }
    }
