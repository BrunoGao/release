...
* @ClassName com.ljwx.modules.customer.domain.dto.customer.config.TCustomerConfigUpdateDTO
* @CreateTime 2024-12-29 - 15:33:30
*/

@Getter
@Setter
@Schema(name = "TCustomerConfigUpdateDTO", description = " 编辑更新 DTO 对象")
public class TCustomerConfigUpdateDTO implements Serializable {
