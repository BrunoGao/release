...
/**
 * 用户健康基线表：支持按日/周/月/年记录每个体征的基线统计值 Mapper 接口层
 *
 * @Author jjgao
 * @ProjectName ljwx-boot
 * @ClassName com.ljwx.modules.health.repository.mapper.THealthBaselineMapper
 * @CreateTime 2025-05-04 - 14:13:02
 */

public interface THealthBaselineMapper extends BaseMapper<THealthBaseline> {
