 ...
 */
@Data
@Schema(description = "动态菜单配置")
public class DynamicMenuConfigDTO implements Serializable {

    @Serial
    private static final long serialVersionUID = 1L;

    @Schema(description = "菜单ID（新增时为空）")
    private Long id;
    ...
    private List<DynamicMenuConfigDTO> children;
