...
* @ClassName com.ljwx.modules.customer.domain.vo.THealthDataConfigVO
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(name = "THealthDataConfigVO", description = " VO 对象")
public class THealthDataConfigVO extends BaseVO {
