...
* @ClassName com.ljwx.modules.geofence.domain.dto.geofence.TGeofenceAddDTO
* @CreateTime 2025-01-07 - 19:44:06
*/

@Getter
@Setter
@Schema(name = "TGeofenceAddDTO", description = " 新增 DTO 对象")
public class TGeofenceAddDTO implements Serializable {
