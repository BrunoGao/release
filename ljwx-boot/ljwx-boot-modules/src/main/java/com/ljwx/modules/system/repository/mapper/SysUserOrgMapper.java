 ...
 */
  ...
  * @ClassName com.ljwx.modules.system.repository.mapper.SysUserOrgMapper
 ...
 public interface SysUserOrgMapper extends BaseMapper<SysUserOrg> {
     ...
     /**清除用户所有主管标记*/
     int clearPrincipal(@Param("userId") Long userId);
     
     /**设置用户主管标记*/
     int setPrincipal(@Param("userId") Long userId, @Param("orgIds") Set<Long> orgIds);
 }