 ...
 * @ClassName com.ljwx.modules.health.service.ITDeviceMessageDetailV2Service
...
public interface ITDeviceMessageDetailV2Service extends IService<TDeviceMessageDetailV2> {
     ...
     * 根据消息ID查询分发详情
     */
    List<TDeviceMessageDetailV2> getByMessageId(Long messageId);

    /**
     * 根据设备序列号查询分发详情
     */
    List<TDeviceMessageDetailV2> getByDeviceSn(String deviceSn, Integer limit);

    /**
     * 根据分发ID查询分发详情
     */
    TDeviceMessageDetailV2 getByDistributionId(String distributionId);

    /**
     * 创建消息分发详情
     */
    TDeviceMessageDetailV2 createDistribution(TDeviceMessageDetailV2 detail);

    /**
     * 批量创建消息分发详情
     */
    List<TDeviceMessageDetailV2> batchCreateDistributions(List<TDeviceMessageDetailV2> details);
     ...
     * 获取待确认的分发
     */
    List<TDeviceMessageDetailV2> getPendingAcknowledgments(Long customerId, Integer limit);

    /**
     * 获取失败的分发
     */
    List<TDeviceMessageDetailV2> getFailedDistributions(Long customerId, Integer limit);
