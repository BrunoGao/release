...
package com.ljwx.admin.annotation;
 ...
 * @ClassName com.ljwx.infrastructure.annotation.AnnotationExtractor
...
public class AnnotationExtractor {
    ...
    public static Map<String, String> extractAllControllerAnnotations() {
        return extractAllControllerAnnotations("com.ljwx.admin.controller");
    }
    ...
    public static void main(String[] args) {
        Map<String, LinkedHashMap<String, LinkedHashMap<List<String>, String>>> annotations =
                extractAllControllerMethodAnnotations("com.ljwx.admin.controller");
        annotations.forEach((controller, methods) -> {
