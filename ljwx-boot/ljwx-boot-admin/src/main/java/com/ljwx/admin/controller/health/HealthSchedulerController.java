 ...
 * @ClassName monitor.controller.com.ljwx.admin.MonSchedulerController
...
@RequestMapping("/health_scheduler")
public class HealthSchedulerController {

    @NonNull
    private IMonSchedulerFacade monSchedulerFacade;

    @GetMapping("/page")
    @SaCheckPermission("health:scheduler:page")
    ...
    @GetMapping("/{id}")
    @SaCheckPermission("health:scheduler:get")
    ...
    @PostMapping("/")
    @SaCheckPermission("health:scheduler:add")
    ...
    @PutMapping("/")
    @SaCheckPermission("health:scheduler:update")
    ...
    @DeleteMapping("/")
    @SaCheckPermission("health:scheduler:delete")
    ...
    @SaCheckPermission("health:scheduler:immediate")
    ...
    @PutMapping("/pause/{id}")
    @SaCheckPermission("health:scheduler:pause")
    ...
    @SaCheckPermission("health:scheduler:pauseGroup")
    ...
    @SaCheckPermission("health:scheduler:resume")
    ...
    @SaCheckPermission("health:scheduler:resumeGroup")
    ...
    @SaCheckPermission("health:scheduler:allJobNames")
