...
const model = defineModel<Api.Health.DeviceUserSearchParams>('model', { required: true });
          ...
          <NGrid responsive="screen" item-responsive :x-gap="8">
            ...
            <NFormItemGi span="24 s:8 m:6" :label="$t('page.health.device.user.status')" path="status">
              <NSelect
                ...
                size="small"
                :placeholder="$t('page.health.device.user.form.status')"
                :options="[{ label: '全部', value: 'all' }, ...dictOptions('bind_status')]"
              />
            </NFormItemGi>
          </NGrid>
        </NGridItem>
