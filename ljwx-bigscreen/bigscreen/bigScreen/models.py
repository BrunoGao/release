...
class DeviceInfoHistory(db.Model):
    ...
    charging_status = db.Column(db.Enum('NOT_CHARGING', 'CHARGING', 'NONE'), nullable=True, comment='充电状态')
...
class DeviceInfo(db.Model):
    ...
    charging_status = db.Column(db.Enum('NOT_CHARGING', 'CHARGING', 'NONE'), nullable=True)
